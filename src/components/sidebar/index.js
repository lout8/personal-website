...
import {SidebarMainBody, SidebarContainer, SidebarBackgroundContainer, SidebarMenu, SidebarItem, SidebarLink, SidebarMedia, SidebarItemMedia} from './sidebarElements'
...
const Sidebar = ({toggle, isOpen}) => {
  return (
    <>
    {/* <SidebarMainBody isOpen={isOpen}></SidebarMainBody> */}
      <SidebarContainer isOpen={isOpen}>
        <SidebarMenu onClick={toggle}>
          ...
          <SidebarItem><SidebarLink to="blog">blog</SidebarLink></SidebarItem>
